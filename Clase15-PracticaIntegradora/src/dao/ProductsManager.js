...
import __dirname from "../utils/utils.js"; // Importing __dirname from utils.js
...
class ProductsManager {
  ...
  async addProduct(producto) {
    try {
      ...
      await fs.promises.writeFile(
        __dirname + "." + this.filePath, // I use __dirname to write the new data in my products.json
  ...
  async updateProduct(id, product) {
    try {
      ...
      await fs.promises.writeFile( // now I write the new data in my products.json using the writeFile method WITH __dirname
